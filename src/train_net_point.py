...
from detectron2.projects.point_sup import PointSupDatasetMapper
...
def add_point_sup_config(cfg):
    ...
    # loss weight for loss_point when boxinst is enabled
    cfg.MODEL.BOXINST.POINT_LOSS_WEIGHT = 1.0
...
def setup(args):
    ...
    rank = comm.get_rank()
    setup_logger(cfg.OUTPUT_DIR, distributed_rank=rank, name="APIS")
