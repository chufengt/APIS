...
for i in range(1, 11):
    key = f"coco_2017_train_points_n{i}_random"
    value = (
        "coco/train2017",
        f"coco/annotations/instances_train2017_n{i}_v1_without_masks.json",
    )
    _PREDEFINED_SPLITS_COCO["coco"][key] = value

for i in range(1, 11):
    key = f"coco_2017_train_points_n{i}_active"
    value = (
        "coco/train2017",
        f"coco/annotations/instances_train2017_n{i}.json",
    )
    _PREDEFINED_SPLITS_COCO["coco"][key] = value
